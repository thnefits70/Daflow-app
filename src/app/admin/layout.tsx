...
// — el bloqueo total de cuenta (RecognitionLockGate) es exclusivo de los
// líderes evaluando a su propio equipo. Al admin solo se le avisa (ya existe
// el aviso obligatorio en Pendientes/push vía getRecognitionAdminPendingItem
// en pendingTasks.ts) — nunca se le corta el acceso al resto de DAFLOW.
