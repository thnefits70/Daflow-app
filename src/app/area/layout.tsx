...
import { SUPPLIER_VIEW_DEPT_CODES, canManageReturnRate, canManageStockouts } from "@/lib/guards";
...
export default async function AreaLayout({ children }: { children: React.ReactNode }) {
  ...
  const showKpis = (await canManageReturnRate()) || (await canManageStockouts());
